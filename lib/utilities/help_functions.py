...
Purpose:
The `HelperFunctions` class provides a suite of data preprocessing utilities to streamline feature engineering and data cleaning for machine learning workflows. It contains methods for:
1. Encoding categorical features using various methods like one-hot, label, ordinal, or custom mappings.
2. Scaling numerical features with Min-Max or Z-score normalization.
3. Imputing missing values in both numerical and categorical columns.
4. Mapping and converting feature types as per user-defined mappings.

This class is especially useful for automating repetitive data preprocessing tasks in a consistent and customizable manner.
